...
<head>
  ...
  <script src="https://cdn.tailwindcss.com"></script>
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/YASHWANTH-MUTHINENI/lytsite@latest/dist-standalone/lytsite-template.css?v=200">
</head>
<body class="min-h-screen bg-slate-50">
  ...
  <!-- Load React bundle -->
  <script src="https://cdn.jsdelivr.net/gh/YASHWANTH-MUTHINENI/lytsite@latest/dist-standalone/lytsite-template.iife.js?v=200"></script>
</body>
</html>`;
}
