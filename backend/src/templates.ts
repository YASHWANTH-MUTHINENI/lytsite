...
<head>
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/YASHWANTH-MUTHINENI/lytsite@master/dist-standalone/lytsite-template.css?v=4">
</head>
<body class="min-h-screen bg-slate-50">
  ...
  <!-- Load React bundle -->
  <script src="https://cdn.jsdelivr.net/gh/YASHWANTH-MUTHINENI/lytsite@master/dist-standalone/lytsite-template.iife.js?v=4"></script>
</body>
</html>`;
}
